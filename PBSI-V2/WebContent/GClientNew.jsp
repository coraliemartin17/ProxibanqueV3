      ...
      <ul class="nav navbar-nav">
		...
		<div class=row>
			...
			<div class="col-sm-5"><div id="bord">
				<form role="form" class="form-horizontal" action="CreateClient" method="post">
					...
					<div class="form-group">
						<label for="codePostal">CodePostal:</label> <input class="form-control"
					...
					<div class="form-group">
						<label for="telephone">telephone:</label> <input class="form-control"
